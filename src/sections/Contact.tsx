    ...
    <section id="contact" className="py-16 sm:py-20 section-border" ref={sectionRef}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-10 items-center">
          <div className="reveal rd1">
            ...
            <div className="flex flex-wrap gap-3">
              <a href={`mailto:${personal.email}`}
                className="group flex items-center gap-2 px-5 py-2.5 rounded-md bg-[#38bdf8] text-[#05080f] text-[13px] font-bold hover:bg-[#7dd3fc] transition-all duration-300 glow-b"
                style={{fontFamily:'Syne,sans-serif'}}>
                <svg width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" className="group-hover:scale-110 transition-transform">
              ...
              <a href={personal.github} target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-2 px-5 py-2.5 rounded-md border border-[#1e3a5f] text-[#7a9bbf] text-[13px] hover:border-[#38bdf8]/35 hover:text-[#c9d8e8] hover:translate-y-[-1px] transition-all duration-300">
          ...
          <div className="reveal rd2 rounded-xl border border-[#1e3a5f]/60 bg-[#08111e] p-6 space-y-4 transition-all duration-300 hover:border-[#38bdf8]/20">
            {[
              ...
              <div key={row.label} className="flex items-center justify-between py-3 border-b border-[#1e3a5f]/40 last:border-0 last:pb-0 group">
